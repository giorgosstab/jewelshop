...
//        }
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        $ratingsDataType = DataType::where('slug', 'wishlists')->firstOrFail();
        $dataRow = $this->dataRow($ratingsDataType, 'id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'hidden',
        ...
        $dataRow = $this->dataRow($ratingsDataType, 'wishlist_belongsto_user_relationship');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'relationship',
                'display_name' => 'users',
        ...
        $dataRow = $this->dataRow($ratingsDataType, 'wishlist_belongsto_product_relationship');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'relationship',
                'display_name' => 'products',
