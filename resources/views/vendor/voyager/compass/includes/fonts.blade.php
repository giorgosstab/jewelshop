<ul class="compass container-fluid nav nav-tabs font-tab">
    <li class="active"><a data-toggle="tab" href="#voyagerfont"><i class="voyager-helm"></i> Voyager Fonts</a></li>
    <li><a data-toggle="tab" href="#voyagermapping"><i class="voyager-character"></i> Voyager Mapping</a></li>
    <li><a data-toggle="tab" href="#fontawesome"><i class="voyager-font"></i> FontAwesome Icons</a></li>
</ul>
<div class="tab-content" style="background-color: #fcfcfc">
    <div id="voyagerfont" class="tab-pane active">
    ...
    <div id="voyagermapping" class="tab-pane">
