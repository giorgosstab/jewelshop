                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone"
                                       value="@if(isset($user->userDetail->phone)){{ $user->userDetail->phone }}@endif">
                            </div>
                            <div class="form-group">
                                <label for="company">Company</label>
                                <input type="text" class="form-control" id="company" name="company" placeholder="Company"
                                       value="@if(isset($user->userDetail->company)){{ $user->userDetail->company }}@endif">
                            </div>
                            <div class="form-group">
                                <label for="city">City</label>
                                <input type="text" class="form-control" id="city" name="city" placeholder="City"
                                       value="@if(isset($user->userDetail->city)){{ $user->userDetail->city }}@endif">
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="address" name="address" placeholder="Address"
                                               value="@if(isset($user->userDetail->address)){{ $user->userDetail->address }}@endif">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="house_number" name="house_number" placeholder="House Number"
                                               value="@if(isset($user->userDetail->house_number)){{ $user->userDetail->house_number }}@endif">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="postal_code" name="postal_code" placeholder="Postal Code"
                                       value="@if(isset($user->userDetail->postal_code)){{ $user->userDetail->postal_code }}@endif">
                            </div>
                            <div class="form-group">
                                <label for="locality">Locality</label>
                                <input type="text" class="form-control" id="locality" name="locality" placeholder="Locality"
                                       value="@if(isset($user->userDetail->locality)){{ $user->userDetail->locality }}@endif">
                            </div>
                        </div>
                    </div>
                </div>
