                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                @else
                                    @if($row->display_name == 'Author Id' || $row->display_name == 'author_id')
                                    ...
                                    @elseif ($row->display_name == 'Category Id' || $row->display_name == 'category_id')
                                        <div class="form-group @if($row->type == 'hidden') hidden @endif col-md-{{ isset($display_options->width) ? $display_options->width : 12 }}" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                            {{ $row->slugify }}
                                            <label for="name">{{ $row->display_name }}</label>
                                            @include('voyager::multilingual.input-hidden-bread-edit-add')
                                        ...
                                        <div class="form-group  col-md-12">
                                            ...
                                            <select class="form-control select2 select2-hidden-accessible" name="tags[]" multiple="" tabindex="-1" aria-hidden="true">
                                                @foreach($allTags as $tag)
                                                    <option {{ $tagsForBlogPosts->contains($tag) ? 'selected' : '' }} value="{{ $tag->id }}">{{ $tag->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    @else
