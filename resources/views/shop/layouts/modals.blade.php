            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <div class="boder3"></div>
                            <p>Already have an account? <a href="#" data-toggle="modal" data-target="#myModalHorizontal1">Log In</a>&nbsp; |&nbsp;<a href="#" data-toggle="modal" data-target="#myModalHorizontal4">Forgot Password</a></p>
                            <div class="boder3"></div>
                        </div>
                    </div>
                </form>
