...
@section('extra-css')
    <style>
        .blog {
            background: url("{{ settingsAdminImageExist(theme('blog_details_parallax'),"blog_details") }}") no-repeat center top fixed;
            padding:150px 0
        }
    </style>
@endsection
            ...
            <div class="shop-in pl-0 pr-0">
                ...
                <div class="bread2">
                    <ul>
                        ...
                        <li>/</li>
                        <li><a href="{{ route('shop.blog.index') }}">{{ theme('blog_title') }}</a>
                        <li>/</li>
                        <li>{{ $post->title }}</li>
                    </ul>
                </div>
