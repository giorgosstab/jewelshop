...
//***************************************
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$request->ajax()) {
            ...
            $requestNew = $request;
            $requestNew['billing_subtotal'] = $request->billing_subtotal * 100;
            $requestNew['billing_tax'] = $request->billing_tax * 100;
            $requestNew['billing_total'] = $request->billing_total * 100;
